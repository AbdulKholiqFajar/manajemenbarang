...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset('images/logo/logobapekom.png') }}" type="image/x-icon" />
  <link rel="shortcut icon" href="{{ asset('images/logo/logobapekom.png') }}" type="image/png" />
