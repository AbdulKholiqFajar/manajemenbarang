        ...
        <form action="{{ route('administrators.students.store') }}" method="POST">
          ...
          <div class="row">
            <div class="col-md-12 col-lg-6">
              <div class="mb-3">
                <label for="identification_number" class="form-label">NIP</label>
                <input type="text" name="identification_number"
                  class="form-control @error('identification_number', 'store') is-invalid @enderror"
                  @if($errors->hasBag('store'))
                value="{{ old('identification_number') }}" @endif placeholder="Masukkan NIP" required>
            ...
            <div class="col-md-12 col-lg-6">
              <div class="mb-3">
                <label for="program_study_id" class="form-label">Jabatan</label>
